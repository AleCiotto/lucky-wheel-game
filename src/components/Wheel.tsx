...
const sliceMap = [
    { label: '0', color: 'bg-blue-500', points: 500 },
    { label: '45', color: 'bg-yellow-500', points: 200 },
    { label: '90', color: 'bg-green-500', points: null },
    { label: '135', color: 'bg-white', points: 150 },
    { label: '180', color: 'bg-red', points: 1000 },
    { label: '225', color: 'bg-orange', points: -250 },
    { label: '270', color: 'bg-blue', points: 0 },
    { label: '315', color: 'bg-white', points: 250 },
];

function Wheel({ onTransitionEnd }: WheelProps) {
    let [degrees, setDegrees] = useState(0);
    let [previousDegrees, setPreviousDegrees] = useState(0);
    ...
    return (
        <>
            ...
            <button className='mt-10 p-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600' onClick={() => {
